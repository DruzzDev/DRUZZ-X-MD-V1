...
async function videoCommand(sock, chatId, message) {
    try {
        ...
        if (!query || query.toLowerCase() === '.video') {
            await sock.sendMessage(chatId, { text: '*ᴜsᴀɢᴇ: .video <ɴᴀᴍᴇ or ʟɪɴᴋ>*' }, { quoted: message });
            return;
        }
        ...
        await sock.sendMessage(chatId, {
            ...
            caption: `*🎥 ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ: ${videoTitle}*`
        }, { quoted: message });
        ...
        if (!downloadSuccess) throw new Error('*ᴀʟʟ ᴅᴏᴡɴʟᴏᴀᴅ sᴏᴜʀᴄᴇs ғᴀɪʟᴇᴅ.*');
